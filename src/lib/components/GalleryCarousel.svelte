...
<div class="carousel-wrapper">
  <button class="scroll-btn left" onclick={() => navigate('left')} aria-label="Previous image">
    <svg
  ...
  <div class="carousel-container">
    <div class="image-card">
      {#key currentIndex}
        ...
        >
          <img src={getImageUrl(images[currentIndex].src)} alt={images[currentIndex].alt} />
        </a>
      {/key}
    </div>
  </div>

  <button class="scroll-btn right" onclick={() => navigate('right')} aria-label="Next image">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
