      ...
      <li class="notification-item" class:unread={hasUnread}>
        <div class="notif-icon update">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            ><path d="M21 2v6h-6"></path><path d="M3 12a9 9 0 0 1 15-6.7L21 8"></path><path
              d="M3 22v-6h6"
            ></path><path d="M21 12a9 9 0 0 1-15 6.7L3 16"></path></svg
          >
        </div>
        <div class="notif-content">
...
<style>
  ...
  .notification-badge {
    ...
    border-radius: 50%;
    box-shadow: 0 0 8px rgba(247, 118, 142, 0.8);
  }
  ...
  .activity-modal {
    ...
    box-shadow:
      ...
      0 0 30px rgba(187, 154, 247, 0.15);
    display: flex;
  ...
  .activity-modal .notification-item {
    padding: 1rem 0;
    border-bottom: none;
  }
  .activity-modal .notif-content p {
    font-size: 1rem;
  }
